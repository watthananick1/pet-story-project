// Topbar.js
import "./topbar.css";
import { Search, Person, Chat, Notifications, DeleteIcon } from "@material-ui/icons";
...
export default function Topbar() {
  ...
  const handleSearchChange = async (event) => {
    ...
    setSearchHistory((prevHistory) => {
      const updatedHistory = [...prevHistory, value].slice(-5);
      ...
      <div className="topbarCenter">
        <div className="searchbar">
          ...
          <Autocomplete
            ...
            sx={{ width: '100%' }}
            freeSolo
            options={[...searchHistory, ...searchOptions]}
                  ...
                  <>
                    <li {...props}>
                      <Stack direction="row" alignItems="center">
                        <span>{option}</span>
                        <IconButton 
                          onClick={() => handleDeleteSearchHistory(option)}
                          aria-label="Delete"
                        >
                          <DeleteIcon />
                        </IconButton>
