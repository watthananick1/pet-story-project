        ...
        querySnapshot.forEach((doc) => {
          ...
          const sortedNotifications = notificationData.sort((a, b) => {
            const timeDiffA = Math.abs(
              currentTime - new Date(a.timestamp.seconds * 1000).getTime()
            );
            const timeDiffB = Math.abs(
              currentTime - new Date(b.timestamp.seconds * 1000).getTime()
            );
          ...
          updatedMessageUser.push({ ...sortedNotifications, formattedDate });
        });
