      ...
      <div className="topbarCenter">
        <div className="searchbar">
          ...
          <Autocomplete
            ...
            getOptionLabel={(option) => option.username || option.content || ""}
            renderInput={(params) => (
              <InputBase
                sx={{ ml: 1, flex: 1 }}
                placeholder="Search"
                ...
                return (
                  <li {...props}>
                    <Stack direction="row" alignItems="center">
                      <Avatar 
                        src={`/api/users/${option.username}/avatar`}
                        sx={{ width: 35, height: 35, mt: 0.5, mb: 0.5, mr: 1 }}
                      />
                      <span>{option.firstName} {option.firstName}</span>
                    </Stack>
                  </li>
                );
              }
                ...
                return (
                  <>
                    <li {...result}>
                      <Stack direction="row" alignItems="center">
                        <Avatar 
                          src={`/api/users/${result.username}/avatar`}
                          sx={{ width: 35, height: 35, mt: 0.5, mb: 0.5, mr: 1 }}
                          // onClick={handleClick}
                        />
