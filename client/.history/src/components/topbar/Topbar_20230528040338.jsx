...
export default function Topbar() {
  ...
  const [users, setUsers] = useState(null); // Corrected variable declaration
  const [posts, setPosts] = useState(null); // Corrected variable declaration

  // Define the searchOptions array
  const searchOptions = [
    { label: users, value: 'option1' },
  ...
  return (
    <div className="topbarContainer">
      ...
      <div className="topbarCenter">
        {/* <SearchData value={searchValue} onEvent={handleSearchChange} /> */}
