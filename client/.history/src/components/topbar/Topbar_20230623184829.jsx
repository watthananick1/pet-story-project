      ...
      <div className="topbarRight">
        ...
        <div className="topbarIconItem">
          {messageData.length > 0 ? (
            <>
              <IconButton key="more" onClick={handleClickNoti}>
              ...
              >
                {messageData.map((notification, index) => (
                  <ItemsList
                    key={index}
                    onAvatar={notification.profilePicture}
                    onBody={notification.body}
                    onName={notification.name}
                    onTitle={notification.title}
                    onTime={notification.formattedDate}
                  />
