            ...
            renderOption={(props, option, state) => {
              ...
              if (searchOptions.length === 0 || searchOptions === null) {
                ...
                if (type === 'User') {
                  return (
                    <>
                      <ListItem key={`user-${option.firstName}`} {...props} onClick={() => handleSearchProfileClick(option.firstName)}>
                ...
                if (type === 'Post') {
                  return (
                    <>
                      <ListItem key={`post-${option.content}`} {...props}>
                        <Stack direction="row" alignItems="center">
