...
export default function Topbar() {
  ...
  const handleSearchChange = async (event) => {
    ...
    setLoading(true); // Set loading state to true while fetching search results
    const searchResults = await performSearch(value); // Call performSearch with the updated value
    setLoading(false); // Set loading state to false once search results are fetched
    ...
    <div className="topbarContainer">
      ...
      <div className="topbarCenter">
        <div className="searchbar">
          ...
          />
          {loading && 
          <div><ReactLoading type="spin" color="#6200E8" height={'10%'} width={'10%'} /></div>
          }
