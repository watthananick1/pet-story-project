...
export default function FilePreviewer({ onClose }) {
  ...
  const cropperRef = useRef(null); // Separate ref for Cropper
            ...
            <Stack direction="row" spacing={2} alignItems="center" mt={2}>
              {imagePreview && (
                <Cropper
                  ...
                  onChange={(newCrop) => {
                    setCrop(newCrop);
                    previewFile(newCrop); // Assuming you want to pass the newCrop value to previewFile
                  }}
                />
              )}
            </Stack>
