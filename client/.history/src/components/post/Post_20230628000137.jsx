      ...
      <Box style={{ "& > *": { height: "100%", width: "100%" } }}>
        {items.map((item, index) => {
          ...
          if (isImage) {
            ...
            const GROUP_NUM_IMAGE = Array.from(
              { length: items.length },
              (_, i) => {
                switch (i + 1) {
                  case 1:
                    return [[setImage(items[0].url.toString())], [setImage(items[1].url.toString())]];
                  case 2:
                    return  [[setImage(items[0].url.toString()), setImage(items[0].url.toString())],
                    [setImage(items[0].url.toString()), setImage(items[0].url.toString())],
                    [setImage(items[0].url.toString()), setImage(items[0].url.toString()L)],];
                  case 3:
                    return THREE;
                  case 4:
                    return FOUR;
