...
export default function Post({ post, onPostUpdate }) {
  ...
  }, [post.member_id, post.id, editedComment]);
  ...
  useEffect(() => {
    ...
    const handlePostUpdate = async (updatedPost) => {
      // Call the onPostUpdate prop callback function with the updated post
      if (onPostUpdate) {
        onPostUpdate(updatedPost);
      }
      // Close the modal and reload the post
      setOpenModal(false);
  ...
  return (
    <div className="post">
      ...
      key={onContentID} // Add key prop with the value of onContentID
      onContent={onContent}
      onContentID={onContentID}
      onCommentsID={onCommentsID}
      onClose={onClose}
      onTitle={onTitle}
      userId={userId}
