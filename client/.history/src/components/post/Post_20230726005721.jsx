...
export default function Post({ isPost, onPostUpdate, indexPost }) {
    ...
    const fetchComments = async () => {
      try {
        const resComments = await axios.get(
          `${pa}/api/comments/${post.id}/Comments`,
          {
            headers: {
  ...
  const handleDeletePost = async () => {
    ...
    try {
      const response = await axios.delete(`${pa}/api/posts/${post.id}`, {
        data: requestBody,
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleDeleteComment = async () => {
    ...
    try {
      const response = await axios.delete(
        `${pa}/api/comments/${post.id}/comments/${commentIdToDelete}`,
        {
          data: requestBody,
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      const resComments = await axios.get(`${pa}/api/comments/${post.id}/Comments`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
