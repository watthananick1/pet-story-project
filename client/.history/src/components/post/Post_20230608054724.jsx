...
export default function Post({ post, onPostUpdate, indexPost }) {
  ...
  const [commentIdUser, setCommentIdToDelete] = useState(null);
  ...
  }, [post.member_id, post.id, onPostUpdate]);
  ...
  const handleDeleteComment = async (commentId) => {
    ...
    try {
      const response = await axios.delete(
        `/api/comments/${post.id}/comments/${commentId}`,
        { data: requestBody }
      );
      const message = response.data.message;
      // Handle the response message here
                  ...
                  return (
                    <div key={index} className="postComment">
                      <div className="postCommentProfile">
                        ...
                        >
                          {dataPUser.member_id === comment.memberId ? (
                            [
