...
export default function Post({ isPost, onPostUpdate, indexPost }) {
  ...
  const SortableList = SortableContainer(({ items }) => {
    ...
    const THREE = [
      ...
      [
        setImage(items[3].url.toString()),
        setImage(items[4].url.toString()),
        setImage(items[5].url.toString()),
      ],
      [
        setImage(items[6].url.toString()),
        setImage(items[7].url.toString()),
        setImage(items[8].url.toString()),
      ],
    ];
  
    const FOUR = [
      ...THREE.map((group) => [...group, setImage(items[9].url.toString())]),
    ];
  
    const FIVE = [
      ...FOUR.map((group) => [...group, setImage(items[10].url.toString())]),
    ];
  
    const MORE = [
      ...THREE.map((group) => [
        ...group,
        setImage(items[9].url.toString()),
        setImage(items[10].url.toString()),
        setImage(items[11].url.toString()),
        setImage(items[12].url.toString()),
      ]),
    ];
