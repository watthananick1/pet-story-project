...
export default function Feed({ firstName }) {
  ...
  }, [user.member_id, firstName, updateTrigger]); // Include 'updateTrigger' as a dependency
    ...
    <div className="feed">
      <div className="feedWrapper">
        ...
        {loading ? (
          ...
          <>
            {posts.map((p) => (
              <Post key={p.id} post={p} onPostUpdate={handlePostUpdate} /> // Pass the callback function to the Post component
            ))}
          </>
        )}
      </div>
