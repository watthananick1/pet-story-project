    ...
    <>
      ...
      <div className="profile">
        ...
        <div className="profileRight">
          <div className="profileRightTop">
            <div className="profileCover">
              ...
              /> */}
              <div className="profileAvatarChange">
        ...
        <Badge
          ...
          badgeContent={
            <label htmlFor="avatarFileInput">
              <span className="profileAvatarButton">Upload</span>
            </label>
          }
        >
          <Avatar
            className="profileUserImg"
            alt="Profile Picture"
            src={avatarFile ? URL.createObjectURL(avatarFile) : user.profilePicture || "/assets/person/noAvatar.png"}
            style={{ width: "150px", height: "150px" }}
          />
        </Badge>
            </div>
